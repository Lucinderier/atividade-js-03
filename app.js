...
*/
const foodsInfo = `Até aqui, o array "brazilianFoods" possui ${brazilianFoods.length} itens: ${brazilianFoods[0]}, ${brazilianFoods[1] === null ? '' : brazilianFoods[1]}, e ${brazilianFoods[2]}.`;
